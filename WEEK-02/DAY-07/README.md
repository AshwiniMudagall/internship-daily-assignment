WEEK-02,DAY-07 TASKS COMPLETED(Uploaded all the Seven Days Program With code and Output)
...
• Handle file errorsmple

6.DAY-06-Programs
• Student management system--menu based & Dictionary application 
